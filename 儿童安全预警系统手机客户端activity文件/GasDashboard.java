...
public class GasDashboard extends View {
    ...
    private static final int DEFAULT_ANIM_PLAY_TIME = 0;//动画时间
    ...
    public GasDashboard(Context context) {
        this(context, null);
    }

    public GasDashboard(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GasDashboard(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawTitleDial(Canvas canvas){
        ...
        canvas.drawText(currentValue + "ppm", 0, radiusDial * 2/3, titlePaint);
    }
